    ...
    <div className="space-y-3 text-center">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <button
          ...
          className="relative z-10 flex items-center justify-center gap-2 w-full h-10 rounded-xl text-[13px] font-medium text-muted-foreground hover:text-foreground cursor-pointer transition-colors"
          style={{ background: "hsl(var(--muted) / 0.10)", pointerEvents: "auto" }}
        >
          <svg className="w-3.5 h-3.5 shrink-0 pointer-events-none" viewBox="0 0 24 24">
